...
var runtime = null, clipScope = null, scene = null, clipPlanes = [];
        ...
        initialize = function() {
            runtime = document.getElementById("x3dcontext").runtime;
...
$('#floor').attr('translation', '0 '+(vol.min.y-vol.max.y)/1.25+' 0');
translateCheck();    
...
$('[type="checkbox"]').change(function(){
    ...
    if(name=="points"){
     document.getElementById("x3dcontext").runtime.togglePoints();
    }
  }   if(name=="points"){
     document.getElementById("x3dcontext").runtime.togglePoints();
    }
